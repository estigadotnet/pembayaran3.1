...
ft103_daf_kelas_siswa_iuranadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t103_daf_kelas_siswa_iuran_add->daf_kelas_siswa_id->Required) { ?>
...
<?php if ($t103_daf_kelas_siswa_iuran->daf_kelas_siswa_id->Visible) { // daf_kelas_siswa_id ?>
	<div id="r_daf_kelas_siswa_id" class="form-group row">
		<label id="elh_t103_daf_kelas_siswa_iuran_daf_kelas_siswa_id" for="x_daf_kelas_siswa_id" class="<?php echo $t103_daf_kelas_siswa_iuran_add->LeftColumnClass ?>"><?php echo $t103_daf_kelas_siswa_iuran->daf_kelas_siswa_id->caption() ?><?php echo ($t103_daf_kelas_siswa_iuran->daf_kelas_siswa_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t103_daf_kelas_siswa_iuran_add->RightColumnClass ?>"><div<?php echo $t103_daf_kelas_siswa_iuran->daf_kelas_siswa_id->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl01", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl02", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl03", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl04", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl05", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl06", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl07", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl08", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl09", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl10", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl11", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<script>
ew.createDateTimePicker("ft103_daf_kelas_siswa_iuranadd", "x_tgl12", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
