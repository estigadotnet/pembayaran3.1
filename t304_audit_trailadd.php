...
var ft304_audit_trailadd = currentForm = new ew.Form("ft304_audit_trailadd", "add");
...
ft304_audit_trailadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($t304_audit_trail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t304_audit_trail_add->Token ?>">
<?php } ?>
...
<?php if ($t304_audit_trail->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group row">
		<label id="elh_t304_audit_trail_datetime" for="x_datetime" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->datetime->caption() ?><?php echo ($t304_audit_trail->datetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->datetime->cellAttributes() ?>>
...
<?php if ($t304_audit_trail->script->Visible) { // script ?>
	<div id="r_script" class="form-group row">
		<label id="elh_t304_audit_trail_script" for="x_script" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->script->caption() ?><?php echo ($t304_audit_trail->script->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->script->cellAttributes() ?>>
...
<?php if ($t304_audit_trail->user->Visible) { // user ?>
	<div id="r_user" class="form-group row">
		<label id="elh_t304_audit_trail_user" for="x_user" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->user->caption() ?><?php echo ($t304_audit_trail->user->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->user->cellAttributes() ?>>
...
<?php if ($t304_audit_trail->_action->Visible) { // action ?>
	<div id="r__action" class="form-group row">
		<label id="elh_t304_audit_trail__action" for="x__action" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->_action->caption() ?><?php echo ($t304_audit_trail->_action->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->_action->cellAttributes() ?>>
...
<?php if ($t304_audit_trail->_table->Visible) { // table ?>
	<div id="r__table" class="form-group row">
		<label id="elh_t304_audit_trail__table" for="x__table" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->_table->caption() ?><?php echo ($t304_audit_trail->_table->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->_table->cellAttributes() ?>>
...
<?php if ($t304_audit_trail->field->Visible) { // field ?>
	<div id="r_field" class="form-group row">
		<label id="elh_t304_audit_trail_field" for="x_field" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->field->caption() ?><?php echo ($t304_audit_trail->field->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->field->cellAttributes() ?>>
...
<?php if ($t304_audit_trail->keyvalue->Visible) { // keyvalue ?>
	<div id="r_keyvalue" class="form-group row">
		<label id="elh_t304_audit_trail_keyvalue" for="x_keyvalue" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->keyvalue->caption() ?><?php echo ($t304_audit_trail->keyvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->keyvalue->cellAttributes() ?>>
...
<?php if ($t304_audit_trail->oldvalue->Visible) { // oldvalue ?>
	<div id="r_oldvalue" class="form-group row">
		<label id="elh_t304_audit_trail_oldvalue" for="x_oldvalue" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->oldvalue->caption() ?><?php echo ($t304_audit_trail->oldvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->oldvalue->cellAttributes() ?>>
...
<?php if ($t304_audit_trail->newvalue->Visible) { // newvalue ?>
	<div id="r_newvalue" class="form-group row">
		<label id="elh_t304_audit_trail_newvalue" for="x_newvalue" class="<?php echo $t304_audit_trail_add->LeftColumnClass ?>"><?php echo $t304_audit_trail->newvalue->caption() ?><?php echo ($t304_audit_trail->newvalue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t304_audit_trail_add->RightColumnClass ?>"><div<?php echo $t304_audit_trail->newvalue->cellAttributes() ?>>
