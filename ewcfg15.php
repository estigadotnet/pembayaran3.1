...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'FX925yYF4Ujv0cNf'); // Random key for encryption
...
$PROJECT_ID = "{D97AB052-DD0F-4E43-8766-C499FD89B1B8}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
define(PROJECT_NAMESPACE . "CASE_SENSITIVE_PASSWORD", TRUE); // Case-sensitive password
...
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_TABLE_NAME", "t304_audit_trail"); // Audit trail table name
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_TABLE_VAR", "t304_audit_trail"); // Audit trail table var
...
define(PROJECT_NAMESPACE . "USER_LEVEL_TABLE", "`t302_userlevels`");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_PRIV_TABLE", "`t303_userlevelpermissions`");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "t301_employees");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "`t301_employees`");
