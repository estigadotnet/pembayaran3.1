...
$sideMenu->addMenuItem(33, "mi_r105_lap_bayar_nr", $ReportLanguage->phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->menuPhrase("33", "MenuText") . $ReportLanguage->phrase("DetailSummaryReportMenuItemSuffix"), "r105_lap_bayar_nrsmry.php", -1, "", AllowListMenu('{5ED375BE-ECE4-4069-8E33-06727256BDB4}r105_lap_bayar_nr'), FALSE, FALSE, "", "", FALSE);
