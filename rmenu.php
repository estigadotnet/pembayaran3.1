...
$sideMenu->addMenuItem(36, "mi_r106_daf_kelas_siswa_iuran", $ReportLanguage->phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->menuPhrase("36", "MenuText") . $ReportLanguage->phrase("DetailSummaryReportMenuItemSuffix"), "r106_daf_kelas_siswa_iuransmry.php", -1, "", AllowListMenu('{5ED375BE-ECE4-4069-8E33-06727256BDB4}r106_daf_kelas_siswa_iuran'), FALSE, FALSE, "", "", FALSE);
