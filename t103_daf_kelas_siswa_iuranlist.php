...
ft103_daf_kelas_siswa_iuranlist.lists["x_iuran_id"] = <?php echo $t103_daf_kelas_siswa_iuran_list->iuran_id->Lookup->toClientList() ?>;
...
<?php } else { ?>
<span id="el<?php echo $t103_daf_kelas_siswa_iuran_list->RowCnt ?>_t103_daf_kelas_siswa_iuran_daf_kelas_siswa_id" class="form-group t103_daf_kelas_siswa_iuran_daf_kelas_siswa_id">
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_daf_kelas_siswa_id" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_daf_kelas_siswa_id" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_daf_kelas_siswa_id" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->daf_kelas_siswa_id->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->daf_kelas_siswa_id->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->daf_kelas_siswa_id->editAttributes() ?>>
</span>
<?php } ?>
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="t103_daf_kelas_siswa_iuran" data-field="x_iuran_id" data-value-separator="<?php echo $t103_daf_kelas_siswa_iuran->iuran_id->displayValueSeparatorAttribute() ?>" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_iuran_id" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_iuran_id"<?php echo $t103_daf_kelas_siswa_iuran->iuran_id->editAttributes() ?>>
		<?php echo $t103_daf_kelas_siswa_iuran->iuran_id->selectOptionListHtml("x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_iuran_id") ?>
	</select>
</div>
<?php echo $t103_daf_kelas_siswa_iuran->iuran_id->Lookup->getParamTag("p_x" . $t103_daf_kelas_siswa_iuran_list->RowIndex . "_iuran_id") ?>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_Jumlah" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_Jumlah" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_Jumlah" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->Jumlah->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->Jumlah->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->Jumlah->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml01" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml01" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml01" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml01->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml01->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml01->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl01" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl01" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl01" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl01->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl01->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl01->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml02" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml02" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml02" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml02->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml02->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml02->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl02" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl02" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl02" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl02->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl02->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl02->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml03" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml03" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml03" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml03->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml03->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml03->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml04" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml04" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml04" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml04->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml04->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml04->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl04" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl04" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl04" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl04->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl04->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl04->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml05" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml05" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml05" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml05->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml05->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml05->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl05" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl05" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl05" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl05->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl05->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl05->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml06" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml06" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml06" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml06->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml06->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml06->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl06" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl06" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl06" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl06->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl06->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl06->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml07" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml07" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml07" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml07->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml07->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml07->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl07" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl07" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl07" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl07->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl07->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl07->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml08" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml08" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml08" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml08->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml08->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml08->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl08" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl08" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl08" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl08->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl08->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl08->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml09" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml09" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml09" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml09->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml09->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml09->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml10" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml10" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml10" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml10->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml10->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml10->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl10" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl10" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl10" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl10->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl10->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl10->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml11" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml11" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml11" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml11->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml11->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml11->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl11" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl11" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl11" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl11->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl11->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl11->editAttributes() ?>>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_jml12" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml12" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_jml12" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->jml12->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->jml12->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->jml12->editAttributes() ?>>
</span>
...
<input type="text" data-table="t103_daf_kelas_siswa_iuran" data-field="x_tgl12" data-format="7" name="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl12" id="x<?php echo $t103_daf_kelas_siswa_iuran_list->RowIndex ?>_tgl12" size="10" placeholder="<?php echo HtmlEncode($t103_daf_kelas_siswa_iuran->tgl12->getPlaceHolder()) ?>" value="<?php echo $t103_daf_kelas_siswa_iuran->tgl12->EditValue ?>"<?php echo $t103_daf_kelas_siswa_iuran->tgl12->editAttributes() ?>>
...
<option value="30"<?php if ($t103_daf_kelas_siswa_iuran_list->DisplayRecs == 30) { ?> selected<?php } ?>>30</option>
