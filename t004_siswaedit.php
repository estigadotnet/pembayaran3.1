...
var ft004_siswaedit = currentForm = new ew.Form("ft004_siswaedit", "edit");
...
ft004_siswaedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($t004_siswa_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t004_siswa_edit->Token ?>">
<?php } ?>
...
<?php if ($t004_siswa->NomorInduk->Visible) { // NomorInduk ?>
	<div id="r_NomorInduk" class="form-group row">
		<label id="elh_t004_siswa_NomorInduk" for="x_NomorInduk" class="<?php echo $t004_siswa_edit->LeftColumnClass ?>"><?php echo $t004_siswa->NomorInduk->caption() ?><?php echo ($t004_siswa->NomorInduk->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t004_siswa_edit->RightColumnClass ?>"><div<?php echo $t004_siswa->NomorInduk->cellAttributes() ?>>
...
<?php if ($t004_siswa->Nama->Visible) { // Nama ?>
	<div id="r_Nama" class="form-group row">
		<label id="elh_t004_siswa_Nama" for="x_Nama" class="<?php echo $t004_siswa_edit->LeftColumnClass ?>"><?php echo $t004_siswa->Nama->caption() ?><?php echo ($t004_siswa->Nama->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t004_siswa_edit->RightColumnClass ?>"><div<?php echo $t004_siswa->Nama->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="t004_siswa" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($t004_siswa->id->CurrentValue) ?>">
