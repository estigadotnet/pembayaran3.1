...
var ft301_employeesadd = currentForm = new ew.Form("ft301_employeesadd", "add");
...
ft301_employeesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft301_employeesadd.lists["x_UserLevel"] = <?php echo $t301_employees_add->UserLevel->Lookup->toClientList() ?>;
ft301_employeesadd.lists["x_UserLevel"].options = <?php echo JsonEncode($t301_employees_add->UserLevel->lookupOptions()) ?>;
ft301_employeesadd.lists["x_Activated[]"] = <?php echo $t301_employees_add->Activated->Lookup->toClientList() ?>;
...
<?php if ($t301_employees_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t301_employees_add->Token ?>">
<?php } ?>
...
<?php if ($t301_employees->LastName->Visible) { // LastName ?>
	<div id="r_LastName" class="form-group row">
		<label id="elh_t301_employees_LastName" for="x_LastName" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->LastName->caption() ?><?php echo ($t301_employees->LastName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->LastName->cellAttributes() ?>>
...
<?php if ($t301_employees->FirstName->Visible) { // FirstName ?>
	<div id="r_FirstName" class="form-group row">
		<label id="elh_t301_employees_FirstName" for="x_FirstName" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->FirstName->caption() ?><?php echo ($t301_employees->FirstName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->FirstName->cellAttributes() ?>>
...
<?php if ($t301_employees->Title->Visible) { // Title ?>
	<div id="r_Title" class="form-group row">
		<label id="elh_t301_employees_Title" for="x_Title" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Title->caption() ?><?php echo ($t301_employees->Title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Title->cellAttributes() ?>>
...
<?php if ($t301_employees->TitleOfCourtesy->Visible) { // TitleOfCourtesy ?>
	<div id="r_TitleOfCourtesy" class="form-group row">
		<label id="elh_t301_employees_TitleOfCourtesy" for="x_TitleOfCourtesy" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->TitleOfCourtesy->caption() ?><?php echo ($t301_employees->TitleOfCourtesy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->TitleOfCourtesy->cellAttributes() ?>>
...
<?php if ($t301_employees->BirthDate->Visible) { // BirthDate ?>
	<div id="r_BirthDate" class="form-group row">
		<label id="elh_t301_employees_BirthDate" for="x_BirthDate" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->BirthDate->caption() ?><?php echo ($t301_employees->BirthDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->BirthDate->cellAttributes() ?>>
...
<?php if ($t301_employees->HireDate->Visible) { // HireDate ?>
	<div id="r_HireDate" class="form-group row">
		<label id="elh_t301_employees_HireDate" for="x_HireDate" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->HireDate->caption() ?><?php echo ($t301_employees->HireDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->HireDate->cellAttributes() ?>>
...
<?php if ($t301_employees->Address->Visible) { // Address ?>
	<div id="r_Address" class="form-group row">
		<label id="elh_t301_employees_Address" for="x_Address" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Address->caption() ?><?php echo ($t301_employees->Address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Address->cellAttributes() ?>>
...
<?php if ($t301_employees->City->Visible) { // City ?>
	<div id="r_City" class="form-group row">
		<label id="elh_t301_employees_City" for="x_City" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->City->caption() ?><?php echo ($t301_employees->City->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->City->cellAttributes() ?>>
...
<?php if ($t301_employees->Region->Visible) { // Region ?>
	<div id="r_Region" class="form-group row">
		<label id="elh_t301_employees_Region" for="x_Region" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Region->caption() ?><?php echo ($t301_employees->Region->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Region->cellAttributes() ?>>
...
<?php if ($t301_employees->PostalCode->Visible) { // PostalCode ?>
	<div id="r_PostalCode" class="form-group row">
		<label id="elh_t301_employees_PostalCode" for="x_PostalCode" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->PostalCode->caption() ?><?php echo ($t301_employees->PostalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->PostalCode->cellAttributes() ?>>
...
<?php if ($t301_employees->Country->Visible) { // Country ?>
	<div id="r_Country" class="form-group row">
		<label id="elh_t301_employees_Country" for="x_Country" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Country->caption() ?><?php echo ($t301_employees->Country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Country->cellAttributes() ?>>
...
<?php if ($t301_employees->HomePhone->Visible) { // HomePhone ?>
	<div id="r_HomePhone" class="form-group row">
		<label id="elh_t301_employees_HomePhone" for="x_HomePhone" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->HomePhone->caption() ?><?php echo ($t301_employees->HomePhone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->HomePhone->cellAttributes() ?>>
...
<?php if ($t301_employees->Extension->Visible) { // Extension ?>
	<div id="r_Extension" class="form-group row">
		<label id="elh_t301_employees_Extension" for="x_Extension" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Extension->caption() ?><?php echo ($t301_employees->Extension->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Extension->cellAttributes() ?>>
...
<?php if ($t301_employees->_Email->Visible) { // Email ?>
	<div id="r__Email" class="form-group row">
		<label id="elh_t301_employees__Email" for="x__Email" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->_Email->caption() ?><?php echo ($t301_employees->_Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->_Email->cellAttributes() ?>>
...
<?php if ($t301_employees->Photo->Visible) { // Photo ?>
	<div id="r_Photo" class="form-group row">
		<label id="elh_t301_employees_Photo" for="x_Photo" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Photo->caption() ?><?php echo ($t301_employees->Photo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Photo->cellAttributes() ?>>
...
<?php if ($t301_employees->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group row">
		<label id="elh_t301_employees_Notes" for="x_Notes" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Notes->caption() ?><?php echo ($t301_employees->Notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Notes->cellAttributes() ?>>
...
<?php if ($t301_employees->ReportsTo->Visible) { // ReportsTo ?>
	<div id="r_ReportsTo" class="form-group row">
		<label id="elh_t301_employees_ReportsTo" for="x_ReportsTo" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->ReportsTo->caption() ?><?php echo ($t301_employees->ReportsTo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->ReportsTo->cellAttributes() ?>>
...
<?php if ($t301_employees->Password->Visible) { // Password ?>
	<div id="r_Password" class="form-group row">
		<label id="elh_t301_employees_Password" for="x_Password" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Password->caption() ?><?php echo ($t301_employees->Password->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Password->cellAttributes() ?>>
...
<?php if ($t301_employees->UserLevel->Visible) { // UserLevel ?>
	<div id="r_UserLevel" class="form-group row">
		<label id="elh_t301_employees_UserLevel" for="x_UserLevel" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->UserLevel->caption() ?><?php echo ($t301_employees->UserLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->UserLevel->cellAttributes() ?>>
...
<?php if ($t301_employees->Username->Visible) { // Username ?>
	<div id="r_Username" class="form-group row">
		<label id="elh_t301_employees_Username" for="x_Username" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Username->caption() ?><?php echo ($t301_employees->Username->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Username->cellAttributes() ?>>
...
<?php if ($t301_employees->Activated->Visible) { // Activated ?>
	<div id="r_Activated" class="form-group row">
		<label id="elh_t301_employees_Activated" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Activated->caption() ?><?php echo ($t301_employees->Activated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Activated->cellAttributes() ?>>
...
<?php if ($t301_employees->Profile->Visible) { // Profile ?>
	<div id="r_Profile" class="form-group row">
		<label id="elh_t301_employees_Profile" for="x_Profile" class="<?php echo $t301_employees_add->LeftColumnClass ?>"><?php echo $t301_employees->Profile->caption() ?><?php echo ($t301_employees->Profile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t301_employees_add->RightColumnClass ?>"><div<?php echo $t301_employees->Profile->cellAttributes() ?>>
