...
$topMenu->addMenuItem(10043, "mi_v113_export_siswa_iuran", $MenuLanguage->MenuPhrase("10043", "MenuText"), "v113_export_siswa_iuranlist.php", 17, "", AllowListMenu('{D97AB052-DD0F-4E43-8766-C499FD89B1B8}v113_export_siswa_iuran'), FALSE, FALSE, "", "", TRUE);
$topMenu->addMenuItem(10096, "mci_Import_Data_Siswa_&_Iuran", $MenuLanguage->MenuPhrase("10096", "MenuText"), "t103_daf_kelas_siswa_iuran", 17, "", IsLoggedIn(), FALSE, TRUE, "", "", TRUE);
...
$topMenu->addMenuItem(8, "mi_t103_daf_kelas_siswa_iuran", $MenuLanguage->MenuPhrase("8", "MenuText"), "t103_daf_kelas_siswa_iuranlist.php?cmd=resetall", 20, "", AllowListMenu('{D97AB052-DD0F-4E43-8766-C499FD89B1B8}t103_daf_kelas_siswa_iuran'), FALSE, FALSE, "", "", TRUE);
$topMenu->addMenuItem(10034, "mri_r105_daf_kelas_iuran", $MenuLanguage->MenuPhrase("10034", "MenuText"), "r105_daf_kelas_iuransmry.php", 20, "{5ED375BE-ECE4-4069-8E33-06727256BDB4}", AllowListMenu('{5ED375BE-ECE4-4069-8E33-06727256BDB4}r105_daf_kelas_iuran'), FALSE, FALSE, "", "", TRUE);
$topMenu->addMenuItem(10042, "mri_r106_daf_kelas_siswa_iuran", $MenuLanguage->MenuPhrase("10042", "MenuText"), "r106_daf_kelas_siswa_iuransmry.php", 20, "{5ED375BE-ECE4-4069-8E33-06727256BDB4}", AllowListMenu('{5ED375BE-ECE4-4069-8E33-06727256BDB4}r106_daf_kelas_siswa_iuran'), FALSE, FALSE, "", "", TRUE);
...
$sideMenu->addMenuItem(10043, "mi_v113_export_siswa_iuran", $MenuLanguage->MenuPhrase("10043", "MenuText"), "v113_export_siswa_iuranlist.php", 17, "", AllowListMenu('{D97AB052-DD0F-4E43-8766-C499FD89B1B8}v113_export_siswa_iuran'), FALSE, FALSE, "", "", TRUE);
$sideMenu->addMenuItem(10096, "mci_Import_Data_Siswa_&_Iuran", $MenuLanguage->MenuPhrase("10096", "MenuText"), "t103_daf_kelas_siswa_iuran", 17, "", IsLoggedIn(), FALSE, TRUE, "", "", TRUE);
...
$sideMenu->addMenuItem(8, "mi_t103_daf_kelas_siswa_iuran", $MenuLanguage->MenuPhrase("8", "MenuText"), "t103_daf_kelas_siswa_iuranlist.php?cmd=resetall", 20, "", AllowListMenu('{D97AB052-DD0F-4E43-8766-C499FD89B1B8}t103_daf_kelas_siswa_iuran'), FALSE, FALSE, "", "", TRUE);
$sideMenu->addMenuItem(10034, "mri_r105_daf_kelas_iuran", $MenuLanguage->MenuPhrase("10034", "MenuText"), "r105_daf_kelas_iuransmry.php", 20, "{5ED375BE-ECE4-4069-8E33-06727256BDB4}", AllowListMenu('{5ED375BE-ECE4-4069-8E33-06727256BDB4}r105_daf_kelas_iuran'), FALSE, FALSE, "", "", TRUE);
$sideMenu->addMenuItem(10042, "mri_r106_daf_kelas_siswa_iuran", $MenuLanguage->MenuPhrase("10042", "MenuText"), "r106_daf_kelas_siswa_iuransmry.php", 20, "{5ED375BE-ECE4-4069-8E33-06727256BDB4}", AllowListMenu('{5ED375BE-ECE4-4069-8E33-06727256BDB4}r106_daf_kelas_siswa_iuran'), FALSE, FALSE, "", "", TRUE);
