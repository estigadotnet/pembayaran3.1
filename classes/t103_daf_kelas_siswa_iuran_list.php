...
class t103_daf_kelas_siswa_iuran_list extends t103_daf_kelas_siswa_iuran
{
	...
	protected function setupImportOptions()
	{
		...
		$item->Body = "<button id=\"imf_t103_daf_kelas_siswa_iuran\" class=\"ew-import-link ew-import\" title=\"" . $Language->phrase("ImportText") . "\" data-caption=\"" . $Language->phrase("ImportText") . "\" onclick=\"ew.importDialogShow({lnk:'imf_t103_daf_kelas_siswa_iuran',hdr:ew.language.phrase('ImportText')});\">" . $Language->phrase("Import") . "</button>";
