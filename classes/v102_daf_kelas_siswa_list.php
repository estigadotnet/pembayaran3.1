 ...
 * Page class
 */
class v102_daf_kelas_siswa_list extends v102_daf_kelas_siswa
{
	...
	// Table name
	public $TableName = 'v102_daf_kelas_siswa';

	// Page object name
	public $PageObjName = "v102_daf_kelas_siswa_list";

	// Grid form hidden field names
	public $FormName = "fv102_daf_kelas_siswalist";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["v102_daf_kelas_siswa"]) || get_class($GLOBALS["v102_daf_kelas_siswa"]) == PROJECT_NAMESPACE . "v102_daf_kelas_siswa") {
			$GLOBALS["v102_daf_kelas_siswa"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["v102_daf_kelas_siswa"];
		}
		...
		$this->AddUrl = "v102_daf_kelas_siswaadd.php?" . TABLE_SHOW_DETAIL . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "v102_daf_kelas_siswadelete.php";
		$this->MultiUpdateUrl = "v102_daf_kelas_siswaupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'v102_daf_kelas_siswa');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fv102_daf_kelas_siswalistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $v102_daf_kelas_siswa;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($v102_daf_kelas_siswa);
				$doc->Text = @$content;
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fv102_daf_kelas_siswalistsrch", $filters);
	...
	protected function setupListOptions()
	{
		...
		// "detail_t103_daf_kelas_siswa_iuran"
		$item = &$this->ListOptions->add("detail_t103_daf_kelas_siswa_iuran");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->allowList(CurrentProjectID() . 't103_daf_kelas_siswa_iuran') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fv102_daf_kelas_siswalistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fv102_daf_kelas_siswalistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fv102_daf_kelas_siswalist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fv102_daf_kelas_siswalistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function renderListOptionsExt()
	{
		...
		// Column "detail_t103_daf_kelas_siswa_iuran"
		if ($this->DetailPages->Items["t103_daf_kelas_siswa_iuran"]->Visible) {
			$link = "";
			$option = &$this->ListOptions->Items["detail_t103_daf_kelas_siswa_iuran"];
			$url = "t103_daf_kelas_siswa_iuranpreview.php?t=v102_daf_kelas_siswa&f=" . Encrypt($sqlwrk);
			...
			if ($Security->allowList(CurrentProjectID() . 't103_daf_kelas_siswa_iuran')) {
				...
				$btngrp .= "<a href=\"javascript:void(0);\" class=\"ew-link-separator\" title=\"" . $Language->TablePhrase("t103_daf_kelas_siswa_iuran", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "'\">" . $Language->Phrase("MasterDetailListLink") . "</a>";
			}
			if (!isset($GLOBALS["t103_daf_kelas_siswa_iuran_grid"]))
				$GLOBALS["t103_daf_kelas_siswa_iuran_grid"] = new t103_daf_kelas_siswa_iuran_grid();
			if ($GLOBALS["t103_daf_kelas_siswa_iuran_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 't103_daf_kelas_siswa_iuran')) {
				$caption = $Language->Phrase("MasterDetailViewLink");
				$url = $this->getViewUrl(TABLE_SHOW_DETAIL . "=t103_daf_kelas_siswa_iuran");
