 ...
 * Page class
 */
class t101_daf_kelas_delete extends t101_daf_kelas
{
	...
	// Page object name
	public $PageObjName = "t101_daf_kelas_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t101_daf_kelaslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t101_daf_kelaslist.php"); // Return to list
			}
		}
	}
