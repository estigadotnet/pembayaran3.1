 ...
 * Page class
 */
class t001_tahun_ajaran_view extends t001_tahun_ajaran
{
	...
	// Page object name
	public $PageObjName = "t001_tahun_ajaran_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t001_tahun_ajaranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t001_tahun_ajaranlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t001_tahun_ajaranlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
