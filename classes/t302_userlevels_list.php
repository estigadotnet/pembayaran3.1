 ...
 * Page class
 */
class t302_userlevels_list extends t302_userlevels
{
	...
	// Table name
	public $TableName = 't302_userlevels';

	// Page object name
	public $PageObjName = "t302_userlevels_list";

	// Grid form hidden field names
	public $FormName = "ft302_userlevelslist";
	...
	public function __construct()
	{
		...
		// Table object (t302_userlevels)
		if (!isset($GLOBALS["t302_userlevels"]) || get_class($GLOBALS["t302_userlevels"]) == PROJECT_NAMESPACE . "t302_userlevels") {
			$GLOBALS["t302_userlevels"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t302_userlevels"];
		}
		...
		$this->AddUrl = "t302_userlevelsadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t302_userlevelsdelete.php";
		$this->MultiUpdateUrl = "t302_userlevelsupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't302_userlevels');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft302_userlevelslistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft302_userlevelslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft302_userlevelslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft302_userlevelslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
