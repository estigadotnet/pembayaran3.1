 ...
 * Page class
 */
class t102_daf_kelas_siswa_view extends t102_daf_kelas_siswa
{
	...
	// Page object name
	public $PageObjName = "t102_daf_kelas_siswa_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t102_daf_kelas_siswalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t102_daf_kelas_siswalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t102_daf_kelas_siswalist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
