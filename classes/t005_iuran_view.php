 ...
 * Page class
 */
class t005_iuran_view extends t005_iuran
{
	...
	// Page object name
	public $PageObjName = "t005_iuran_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t005_iuranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t005_iuranlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t005_iuranlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
