 ...
 * Page class
 */
class t301_employees_list extends t301_employees
{
	...
	// Table name
	public $TableName = 't301_employees';

	// Page object name
	public $PageObjName = "t301_employees_list";

	// Grid form hidden field names
	public $FormName = "ft301_employeeslist";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["t301_employees"]) || get_class($GLOBALS["t301_employees"]) == PROJECT_NAMESPACE . "t301_employees") {
			$GLOBALS["t301_employees"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t301_employees"];
		}
		...
		$this->AddUrl = "t301_employeesadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t301_employeesdelete.php";
		$this->MultiUpdateUrl = "t301_employeesupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't301_employees');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft301_employeeslistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft301_employeeslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft301_employeeslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft301_employeeslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
