...
class c302_backup
{
	...
	// Table name
	public $TableName = 'c302_backup.php';

	// Page object name
	public $PageObjName = "c302_backup";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c302_backup.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c302_backup", $url, "", "c302_backup", TRUE);
		$this->Heading = $Language->TablePhrase("c302_backup", "TblCaption"); 
	}
}
?>