...
/**
 * Table class for r105_lap_bayar_nr
 */
class r105_lap_bayar_nr extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'r105_lap_bayar_nr';
		$this->TableName = 'r105_lap_bayar_nr';
		...
		// keterangan
		$this->keterangan = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_keterangan', 'keterangan', '`keterangan`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TahunAjaran
		$this->TahunAjaran = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_TahunAjaran', 'TahunAjaran', '`TahunAjaran`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TahunAjaran->Lookup = new ReportLookup('TahunAjaran', 'r105_lap_bayar_nr', TRUE, 'TahunAjaran', ["TahunAjaran","","",""], [], [], [], [], [], [], '`TahunAjaran` ASC', '');
		$this->TahunAjaran->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['TahunAjaran'] = &$this->TahunAjaran;

		// SekolahNama
		$this->SekolahNama = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_SekolahNama', 'SekolahNama', '`SekolahNama`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->SekolahNama->Lookup = new ReportLookup('SekolahNama', 'r105_lap_bayar_nr', TRUE, 'SekolahNama', ["SekolahNama","","",""], [], [], [], [], [], [], '`SekolahNama` ASC', '');
		$this->SekolahNama->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['SekolahNama'] = &$this->SekolahNama;

		// KelasNama
		$this->KelasNama = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_KelasNama', 'KelasNama', '`KelasNama`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->KelasNama->Lookup = new ReportLookup('KelasNama', 'r105_lap_bayar_nr', TRUE, 'KelasNama', ["KelasNama","","",""], [], [], [], [], [], [], '`KelasNama` ASC', '');
		$this->KelasNama->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['KelasNama'] = &$this->KelasNama;

		// NomorInduk
		$this->NomorInduk = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_NomorInduk', 'NomorInduk', '`NomorInduk`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NomorInduk->Sortable = TRUE; // Allow sort
		$this->NomorInduk->DateFilter = "";
		$this->fields['NomorInduk'] = &$this->NomorInduk;

		// SiswaNama
		$this->SiswaNama = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_SiswaNama', 'SiswaNama', '`SiswaNama`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SiswaNama->Sortable = TRUE; // Allow sort
		$this->SiswaNama->DateFilter = "";
		$this->fields['SiswaNama'] = &$this->SiswaNama;

		// iuran_id
		$this->iuran_id = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_iuran_id', 'iuran_id', '`iuran_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->iuran_id->Sortable = TRUE; // Allow sort
		$this->iuran_id->GroupingFieldId = 2;
		$this->iuran_id->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->iuran_id->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->iuran_id->DefaultErrorMessage = $ReportLanguage->phrase("IncorrectInteger");
		$this->iuran_id->DateFilter = "";
		$this->iuran_id->GroupByType = "";
		$this->iuran_id->GroupInterval = "0";
		$this->iuran_id->GroupSql = "";
		$this->fields['iuran_id'] = &$this->iuran_id;

		// IuranNama
		$this->IuranNama = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_IuranNama', 'IuranNama', '`IuranNama`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->IuranNama->Sortable = TRUE; // Allow sort
		$this->IuranNama->SelectMultiple = TRUE; // Multiple select
		$this->IuranNama->GroupingFieldId = 3;
		$this->IuranNama->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->IuranNama->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->IuranNama->DateFilter = "";
		$this->IuranNama->Lookup = new ReportLookup('IuranNama', 'r105_lap_bayar_nr', TRUE, 'IuranNama', ["IuranNama","","",""], [], [], [], [], [], [], '`IuranNama` ASC', '');
		$this->IuranNama->Lookup->RenderViewFunc = "renderLookup";
		$this->IuranNama->GroupByType = "";
		$this->IuranNama->GroupInterval = "0";
		$this->IuranNama->GroupSql = "";
		$this->fields['IuranNama'] = &$this->IuranNama;

		// Jumlah
		$this->Jumlah = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_Jumlah', 'Jumlah', '`Jumlah`', 4, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Jumlah->Sortable = TRUE; // Allow sort
		$this->Jumlah->GroupingFieldId = 4;
		...
		// Periode
		$this->Periode = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_Periode', 'Periode', '`Periode`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PeriodeBulan
		$this->PeriodeBulan = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_PeriodeBulan', 'PeriodeBulan', '`PeriodeBulan`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PeriodeBulan->Sortable = TRUE; // Allow sort
		$this->PeriodeBulan->DateFilter = "";
		$this->fields['PeriodeBulan'] = &$this->PeriodeBulan;

		// TglBayar
		$this->TglBayar = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_TglBayar', 'TglBayar', '`TglBayar`', 133, 7, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TglBayar->Sortable = TRUE; // Allow sort
		$this->TglBayar->DefaultErrorMessage = $ReportLanguage->phrase("IncorrectField");
		$this->TglBayar->DateFilter = "";
		$this->fields['TglBayar'] = &$this->TglBayar;

		// JumlahBayar
		$this->JumlahBayar = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_JumlahBayar', 'JumlahBayar', '`JumlahBayar`', 4, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// dk_id
		$this->dk_id = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_dk_id', 'dk_id', '`dk_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// daf_kelas_siswa_id
		$this->daf_kelas_siswa_id = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_daf_kelas_siswa_id', 'daf_kelas_siswa_id', '`daf_kelas_siswa_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun_ajaran_id
		$this->tahun_ajaran_id = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_tahun_ajaran_id', 'tahun_ajaran_id', '`tahun_ajaran_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sekolah_id
		$this->sekolah_id = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_sekolah_id', 'sekolah_id', '`sekolah_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kelas_id
		$this->kelas_id = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_kelas_id', 'kelas_id', '`kelas_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// siswa_id
		$this->siswa_id = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_siswa_id', 'siswa_id', '`siswa_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StatusBayar
		$this->StatusBayar = new ReportField('r105_lap_bayar_nr', 'r105_lap_bayar_nr', 'x_StatusBayar', 'StatusBayar', '`StatusBayar`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`v115_lap_bayar`";
	}
	...
	{
		return ($this->_sqlOrderBy <> "") ? $this->_sqlOrderBy : "`keterangan` ASC, `iuran_id` ASC, `IuranNama` ASC, `Jumlah` ASC";
	}
