 ...
 * Page class
 */
class t304_audit_trail_delete extends t304_audit_trail
{
	...
	// Page object name
	public $PageObjName = "t304_audit_trail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t304_audit_traillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t304_audit_traillist.php"); // Return to list
			}
		}
	}
