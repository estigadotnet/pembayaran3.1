...
class c303_import
{
	...
	// Table name
	public $TableName = 'c303_import.php';

	// Page object name
	public $PageObjName = "c303_import";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c303_import.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c303_import", $url, "", "c303_import", TRUE);
		$this->Heading = $Language->TablePhrase("c303_import", "TblCaption"); 
	}
}
?>