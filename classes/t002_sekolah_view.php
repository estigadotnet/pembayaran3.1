 ...
 * Page class
 */
class t002_sekolah_view extends t002_sekolah
{
	...
	// Page object name
	public $PageObjName = "t002_sekolah_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t002_sekolahlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t002_sekolahlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t002_sekolahlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t002_sekolahlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t002_sekolahlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
