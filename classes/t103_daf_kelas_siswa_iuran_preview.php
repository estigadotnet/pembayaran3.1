 ...
 * Page class
 */
class t103_daf_kelas_siswa_iuran_preview extends t103_daf_kelas_siswa_iuran
{
	...
	// Page object name
	public $PageObjName = "t103_daf_kelas_siswa_iuran_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 't103_daf_kelas_siswa_iuran');
			if ($Security->isLoggedIn())
