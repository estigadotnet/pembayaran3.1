...
/**
 * Table class for t304_audit_trail
 */
class t304_audit_trail extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't304_audit_trail';
		$this->TableName = 't304_audit_trail';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t304_audit_trail`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t304_audit_trail', 't304_audit_trail', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('t304_audit_trail', 't304_audit_trail', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike('`datetime`', 0, "DB"), 135, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// script
		$this->script = new DbField('t304_audit_trail', 't304_audit_trail', 'x_script', 'script', '`script`', '`script`', 200, -1, FALSE, '`script`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->script->Sortable = TRUE; // Allow sort
		$this->fields['script'] = &$this->script;

		// user
		$this->user = new DbField('t304_audit_trail', 't304_audit_trail', 'x_user', 'user', '`user`', '`user`', 200, -1, FALSE, '`user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user->Sortable = TRUE; // Allow sort
		$this->fields['user'] = &$this->user;

		// action
		$this->_action = new DbField('t304_audit_trail', 't304_audit_trail', 'x__action', 'action', '`action`', '`action`', 200, -1, FALSE, '`action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_action->Sortable = TRUE; // Allow sort
		$this->fields['action'] = &$this->_action;

		// table
		$this->_table = new DbField('t304_audit_trail', 't304_audit_trail', 'x__table', 'table', '`table`', '`table`', 200, -1, FALSE, '`table`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_table->Sortable = TRUE; // Allow sort
		$this->fields['table'] = &$this->_table;

		// field
		$this->field = new DbField('t304_audit_trail', 't304_audit_trail', 'x_field', 'field', '`field`', '`field`', 200, -1, FALSE, '`field`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field->Sortable = TRUE; // Allow sort
		$this->fields['field'] = &$this->field;

		// keyvalue
		$this->keyvalue = new DbField('t304_audit_trail', 't304_audit_trail', 'x_keyvalue', 'keyvalue', '`keyvalue`', '`keyvalue`', 201, -1, FALSE, '`keyvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->keyvalue->Sortable = TRUE; // Allow sort
		$this->fields['keyvalue'] = &$this->keyvalue;

		// oldvalue
		$this->oldvalue = new DbField('t304_audit_trail', 't304_audit_trail', 'x_oldvalue', 'oldvalue', '`oldvalue`', '`oldvalue`', 201, -1, FALSE, '`oldvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->oldvalue->Sortable = TRUE; // Allow sort
		$this->fields['oldvalue'] = &$this->oldvalue;

		// newvalue
		$this->newvalue = new DbField('t304_audit_trail', 't304_audit_trail', 'x_newvalue', 'newvalue', '`newvalue`', '`newvalue`', 201, -1, FALSE, '`newvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t304_audit_trail`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t304_audit_traillist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "t304_audit_trailview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t304_audit_trailedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t304_audit_trailadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t304_audit_trailview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t304_audit_trailview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t304_audit_trailadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t304_audit_trailadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t304_audit_trailedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t304_audit_trailadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t304_audit_traildelete.php", $this->getUrlParm());
	}
