...
class c301_home
{
	...
	// Table name
	public $TableName = 'c301_home.php';

	// Page object name
	public $PageObjName = "c301_home";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c301_home.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c301_home", $url, "", "c301_home", TRUE);
		$this->Heading = $Language->TablePhrase("c301_home", "TblCaption"); 
	}
}
?>