...
class t003_kelas extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('t003_kelas', 't003_kelas', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Nama
		$this->Nama = new DbField('t003_kelas', 't003_kelas', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("t003_kelasview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
