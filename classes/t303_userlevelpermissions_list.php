 ...
 * Page class
 */
class t303_userlevelpermissions_list extends t303_userlevelpermissions
{
	...
	// Table name
	public $TableName = 't303_userlevelpermissions';

	// Page object name
	public $PageObjName = "t303_userlevelpermissions_list";

	// Grid form hidden field names
	public $FormName = "ft303_userlevelpermissionslist";
	...
	public function __construct()
	{
		...
		// Table object (t303_userlevelpermissions)
		if (!isset($GLOBALS["t303_userlevelpermissions"]) || get_class($GLOBALS["t303_userlevelpermissions"]) == PROJECT_NAMESPACE . "t303_userlevelpermissions") {
			$GLOBALS["t303_userlevelpermissions"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t303_userlevelpermissions"];
		}
		...
		$this->AddUrl = "t303_userlevelpermissionsadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t303_userlevelpermissionsdelete.php";
		$this->MultiUpdateUrl = "t303_userlevelpermissionsupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't303_userlevelpermissions');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft303_userlevelpermissionslistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $t303_userlevelpermissions;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($t303_userlevelpermissions);
				$doc->Text = @$content;
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft303_userlevelpermissionslistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft303_userlevelpermissionslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft303_userlevelpermissionslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft303_userlevelpermissionslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft303_userlevelpermissionslistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
