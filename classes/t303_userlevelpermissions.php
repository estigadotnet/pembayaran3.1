...
/**
 * Table class for t303_userlevelpermissions
 */
class t303_userlevelpermissions extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't303_userlevelpermissions';
		$this->TableName = 't303_userlevelpermissions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t303_userlevelpermissions`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('t303_userlevelpermissions', 't303_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new DbField('t303_userlevelpermissions', 't303_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new DbField('t303_userlevelpermissions', 't303_userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t303_userlevelpermissions`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t303_userlevelpermissionslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "t303_userlevelpermissionsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t303_userlevelpermissionsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t303_userlevelpermissionsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t303_userlevelpermissionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t303_userlevelpermissionsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t303_userlevelpermissionsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t303_userlevelpermissionsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t303_userlevelpermissionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t303_userlevelpermissionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t303_userlevelpermissionsdelete.php", $this->getUrlParm());
	}
	...
	{
		$table = 't303_userlevelpermissions';
		$usr = CurrentUserID();
