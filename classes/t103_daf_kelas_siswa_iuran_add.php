 ...
 * Page class
 */
class t103_daf_kelas_siswa_iuran_add extends t103_daf_kelas_siswa_iuran
{
	...
	// Page object name
	public $PageObjName = "t103_daf_kelas_siswa_iuran_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t103_daf_kelas_siswa_iuranview.php")
