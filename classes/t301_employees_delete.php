 ...
 * Page class
 */
class t301_employees_delete extends t301_employees
{
	...
	// Page object name
	public $PageObjName = "t301_employees_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t301_employeeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("t301_employeeslist.php"); // Return to list
				return;
			}
		}
