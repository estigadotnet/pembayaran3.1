 ...
 * Page class
 */
class t101_daf_kelas_edit extends t101_daf_kelas
{
	...
	// Page object name
	public $PageObjName = "t101_daf_kelas_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("t102_daf_kelas_siswa", $detailTblVar) && $GLOBALS["t102_daf_kelas_siswa"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("t102_daf_kelas_siswa", $detailTblVar) && $GLOBALS["t102_daf_kelas_siswa"]->DetailEdit) {
						...
						$editRow = $GLOBALS["t102_daf_kelas_siswa_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("t102_daf_kelas_siswa", $detailTblVar)) {
				...
				if ($GLOBALS["t102_daf_kelas_siswa_grid"]->DetailEdit) {
					$GLOBALS["t102_daf_kelas_siswa_grid"]->CurrentMode = "edit";
					$GLOBALS["t102_daf_kelas_siswa_grid"]->CurrentAction = "gridedit";
