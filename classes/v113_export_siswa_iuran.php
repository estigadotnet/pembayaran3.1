...
/**
 * Table class for v113_export_siswa_iuran
 */
class v113_export_siswa_iuran extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v113_export_siswa_iuran';
		$this->TableName = 'v113_export_siswa_iuran';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v113_export_siswa_iuran`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// daf_kelas_siswa_id
		$this->daf_kelas_siswa_id = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_daf_kelas_siswa_id', 'daf_kelas_siswa_id', '`daf_kelas_siswa_id`', '`daf_kelas_siswa_id`', 3, -1, FALSE, '`daf_kelas_siswa_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// iuran_id
		$this->iuran_id = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_iuran_id', 'iuran_id', '`iuran_id`', '`iuran_id`', 3, -1, FALSE, '`iuran_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Jumlah
		$this->Jumlah = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_Jumlah', 'Jumlah', '`Jumlah`', '`Jumlah`', 4, -1, FALSE, '`Jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr01
		$this->byr01 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr01', 'byr01', '`byr01`', '`byr01`', 202, -1, FALSE, '`byr01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr01->Nullable = FALSE; // NOT NULL field
		$this->byr01->Sortable = TRUE; // Allow sort
		$this->byr01->DataType = DATATYPE_BOOLEAN;
		$this->byr01->Lookup = new Lookup('byr01', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr01->OptionCount = 2;
		$this->fields['byr01'] = &$this->byr01;

		// jml01
		$this->jml01 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml01', 'jml01', '`jml01`', '`jml01`', 4, -1, FALSE, '`jml01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl01
		$this->tgl01 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl01', 'tgl01', '`tgl01`', CastDateFieldForLike('`tgl01`', 0, "DB"), 133, 0, FALSE, '`tgl01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr02
		$this->byr02 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr02', 'byr02', '`byr02`', '`byr02`', 202, -1, FALSE, '`byr02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr02->Nullable = FALSE; // NOT NULL field
		$this->byr02->Sortable = TRUE; // Allow sort
		$this->byr02->DataType = DATATYPE_BOOLEAN;
		$this->byr02->Lookup = new Lookup('byr02', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr02->OptionCount = 2;
		$this->fields['byr02'] = &$this->byr02;

		// jml02
		$this->jml02 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml02', 'jml02', '`jml02`', '`jml02`', 4, -1, FALSE, '`jml02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl02
		$this->tgl02 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl02', 'tgl02', '`tgl02`', CastDateFieldForLike('`tgl02`', 0, "DB"), 133, 0, FALSE, '`tgl02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr03
		$this->byr03 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr03', 'byr03', '`byr03`', '`byr03`', 202, -1, FALSE, '`byr03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr03->Nullable = FALSE; // NOT NULL field
		$this->byr03->Sortable = TRUE; // Allow sort
		$this->byr03->DataType = DATATYPE_BOOLEAN;
		$this->byr03->Lookup = new Lookup('byr03', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr03->OptionCount = 2;
		$this->fields['byr03'] = &$this->byr03;

		// jml03
		$this->jml03 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml03', 'jml03', '`jml03`', '`jml03`', 4, -1, FALSE, '`jml03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl03
		$this->tgl03 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl03', 'tgl03', '`tgl03`', CastDateFieldForLike('`tgl03`', 0, "DB"), 133, 0, FALSE, '`tgl03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr04
		$this->byr04 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr04', 'byr04', '`byr04`', '`byr04`', 202, -1, FALSE, '`byr04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr04->Nullable = FALSE; // NOT NULL field
		$this->byr04->Sortable = TRUE; // Allow sort
		$this->byr04->DataType = DATATYPE_BOOLEAN;
		$this->byr04->Lookup = new Lookup('byr04', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr04->OptionCount = 2;
		$this->fields['byr04'] = &$this->byr04;

		// jml04
		$this->jml04 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml04', 'jml04', '`jml04`', '`jml04`', 4, -1, FALSE, '`jml04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl04
		$this->tgl04 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl04', 'tgl04', '`tgl04`', CastDateFieldForLike('`tgl04`', 0, "DB"), 133, 0, FALSE, '`tgl04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr05
		$this->byr05 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr05', 'byr05', '`byr05`', '`byr05`', 202, -1, FALSE, '`byr05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr05->Nullable = FALSE; // NOT NULL field
		$this->byr05->Sortable = TRUE; // Allow sort
		$this->byr05->DataType = DATATYPE_BOOLEAN;
		$this->byr05->Lookup = new Lookup('byr05', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr05->OptionCount = 2;
		$this->fields['byr05'] = &$this->byr05;

		// jml05
		$this->jml05 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml05', 'jml05', '`jml05`', '`jml05`', 4, -1, FALSE, '`jml05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl05
		$this->tgl05 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl05', 'tgl05', '`tgl05`', CastDateFieldForLike('`tgl05`', 0, "DB"), 133, 0, FALSE, '`tgl05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr06
		$this->byr06 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr06', 'byr06', '`byr06`', '`byr06`', 202, -1, FALSE, '`byr06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr06->Nullable = FALSE; // NOT NULL field
		$this->byr06->Sortable = TRUE; // Allow sort
		$this->byr06->DataType = DATATYPE_BOOLEAN;
		$this->byr06->Lookup = new Lookup('byr06', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr06->OptionCount = 2;
		$this->fields['byr06'] = &$this->byr06;

		// jml06
		$this->jml06 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml06', 'jml06', '`jml06`', '`jml06`', 4, -1, FALSE, '`jml06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl06
		$this->tgl06 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl06', 'tgl06', '`tgl06`', CastDateFieldForLike('`tgl06`', 0, "DB"), 133, 0, FALSE, '`tgl06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr07
		$this->byr07 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr07', 'byr07', '`byr07`', '`byr07`', 202, -1, FALSE, '`byr07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr07->Nullable = FALSE; // NOT NULL field
		$this->byr07->Sortable = TRUE; // Allow sort
		$this->byr07->DataType = DATATYPE_BOOLEAN;
		$this->byr07->Lookup = new Lookup('byr07', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr07->OptionCount = 2;
		$this->fields['byr07'] = &$this->byr07;

		// jml07
		$this->jml07 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml07', 'jml07', '`jml07`', '`jml07`', 4, -1, FALSE, '`jml07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl07
		$this->tgl07 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl07', 'tgl07', '`tgl07`', CastDateFieldForLike('`tgl07`', 0, "DB"), 133, 0, FALSE, '`tgl07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr08
		$this->byr08 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr08', 'byr08', '`byr08`', '`byr08`', 202, -1, FALSE, '`byr08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr08->Nullable = FALSE; // NOT NULL field
		$this->byr08->Sortable = TRUE; // Allow sort
		$this->byr08->DataType = DATATYPE_BOOLEAN;
		$this->byr08->Lookup = new Lookup('byr08', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr08->OptionCount = 2;
		$this->fields['byr08'] = &$this->byr08;

		// jml08
		$this->jml08 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml08', 'jml08', '`jml08`', '`jml08`', 4, -1, FALSE, '`jml08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl08
		$this->tgl08 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl08', 'tgl08', '`tgl08`', CastDateFieldForLike('`tgl08`', 0, "DB"), 133, 0, FALSE, '`tgl08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr09
		$this->byr09 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr09', 'byr09', '`byr09`', '`byr09`', 202, -1, FALSE, '`byr09`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr09->Nullable = FALSE; // NOT NULL field
		$this->byr09->Sortable = TRUE; // Allow sort
		$this->byr09->DataType = DATATYPE_BOOLEAN;
		$this->byr09->Lookup = new Lookup('byr09', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr09->OptionCount = 2;
		$this->fields['byr09'] = &$this->byr09;

		// jml09
		$this->jml09 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml09', 'jml09', '`jml09`', '`jml09`', 4, -1, FALSE, '`jml09`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl09
		$this->tgl09 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl09', 'tgl09', '`tgl09`', CastDateFieldForLike('`tgl09`', 0, "DB"), 133, 0, FALSE, '`tgl09`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr10
		$this->byr10 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr10', 'byr10', '`byr10`', '`byr10`', 202, -1, FALSE, '`byr10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr10->Nullable = FALSE; // NOT NULL field
		$this->byr10->Sortable = TRUE; // Allow sort
		$this->byr10->DataType = DATATYPE_BOOLEAN;
		$this->byr10->Lookup = new Lookup('byr10', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr10->OptionCount = 2;
		$this->fields['byr10'] = &$this->byr10;

		// jml10
		$this->jml10 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml10', 'jml10', '`jml10`', '`jml10`', 4, -1, FALSE, '`jml10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl10
		$this->tgl10 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl10', 'tgl10', '`tgl10`', CastDateFieldForLike('`tgl10`', 0, "DB"), 133, 0, FALSE, '`tgl10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr11
		$this->byr11 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr11', 'byr11', '`byr11`', '`byr11`', 202, -1, FALSE, '`byr11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr11->Nullable = FALSE; // NOT NULL field
		$this->byr11->Sortable = TRUE; // Allow sort
		$this->byr11->DataType = DATATYPE_BOOLEAN;
		$this->byr11->Lookup = new Lookup('byr11', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr11->OptionCount = 2;
		$this->fields['byr11'] = &$this->byr11;

		// jml11
		$this->jml11 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml11', 'jml11', '`jml11`', '`jml11`', 4, -1, FALSE, '`jml11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl11
		$this->tgl11 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl11', 'tgl11', '`tgl11`', CastDateFieldForLike('`tgl11`', 0, "DB"), 133, 0, FALSE, '`tgl11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// byr12
		$this->byr12 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_byr12', 'byr12', '`byr12`', '`byr12`', 202, -1, FALSE, '`byr12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->byr12->Nullable = FALSE; // NOT NULL field
		$this->byr12->Sortable = TRUE; // Allow sort
		$this->byr12->DataType = DATATYPE_BOOLEAN;
		$this->byr12->Lookup = new Lookup('byr12', 'v113_export_siswa_iuran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->byr12->OptionCount = 2;
		$this->fields['byr12'] = &$this->byr12;

		// jml12
		$this->jml12 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_jml12', 'jml12', '`jml12`', '`jml12`', 4, -1, FALSE, '`jml12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl12
		$this->tgl12 = new DbField('v113_export_siswa_iuran', 'v113_export_siswa_iuran', 'x_tgl12', 'tgl12', '`tgl12`', CastDateFieldForLike('`tgl12`', 0, "DB"), 133, 0, FALSE, '`tgl12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`v113_export_siswa_iuran`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v113_export_siswa_iuranlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "v113_export_siswa_iuranview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v113_export_siswa_iuranedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v113_export_siswa_iuranadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("v113_export_siswa_iuranview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v113_export_siswa_iuranview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "v113_export_siswa_iuranadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v113_export_siswa_iuranadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v113_export_siswa_iuranedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v113_export_siswa_iuranadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v113_export_siswa_iurandelete.php", $this->getUrlParm());
	}
