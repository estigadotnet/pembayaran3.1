...
/**
 * Table class for r105_daf_kelas_iuran
 */
class r105_daf_kelas_iuran extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'r105_daf_kelas_iuran';
		$this->TableName = 'r105_daf_kelas_iuran';
		...
		// dk_id
		$this->dk_id = new ReportField('r105_daf_kelas_iuran', 'r105_daf_kelas_iuran', 'x_dk_id', 'dk_id', '`dk_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tsk
		$this->tsk = new ReportField('r105_daf_kelas_iuran', 'r105_daf_kelas_iuran', 'x_tsk', 'tsk', '`tsk`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->tsk->Sortable = TRUE; // Allow sort
		$this->tsk->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->tsk->PleaseSelectText = $ReportLanguage->phrase("PleaseSelect"); // PleaseSelect text
		$this->tsk->DateFilter = "";
		$this->tsk->Lookup = new ReportLookup('tsk', 'r105_daf_kelas_iuran', TRUE, 'tsk', ["tsk","","",""], [], [], [], [], [], [], '`tsk` ASC', '');
		$this->tsk->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['tsk'] = &$this->tsk;

		// iuran_id
		$this->iuran_id = new ReportField('r105_daf_kelas_iuran', 'r105_daf_kelas_iuran', 'x_iuran_id', 'iuran_id', '`iuran_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama
		$this->nama = new ReportField('r105_daf_kelas_iuran', 'r105_daf_kelas_iuran', 'x_nama', 'nama', '`nama`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->nama->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->nama->PleaseSelectText = $ReportLanguage->phrase("PleaseSelect"); // PleaseSelect text
		$this->nama->DateFilter = "";
		$this->nama->Lookup = new ReportLookup('nama', 'r105_daf_kelas_iuran', TRUE, 'nama', ["nama","","",""], [], [], [], [], [], [], '`nama` ASC', '');
		$this->nama->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['nama'] = &$this->nama;

		// jumlah
		$this->jumlah = new ReportField('r105_daf_kelas_iuran', 'r105_daf_kelas_iuran', 'x_jumlah', 'jumlah', '`jumlah`', 4, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlah_siswa
		$this->jumlah_siswa = new ReportField('r105_daf_kelas_iuran', 'r105_daf_kelas_iuran', 'x_jumlah_siswa', 'jumlah_siswa', '`jumlah_siswa`', 20, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jumlah_siswa->Sortable = TRUE; // Allow sort
		$this->jumlah_siswa->DefaultErrorMessage = $ReportLanguage->phrase("IncorrectInteger");
		$this->jumlah_siswa->DateFilter = "";
		$this->fields['jumlah_siswa'] = &$this->jumlah_siswa;
	}
	...
	{
		$this->tsk->ViewValue = GetDropDownDisplayValue($this->tsk->CurrentValue, "", 0);
		$this->nama->ViewValue = GetDropDownDisplayValue($this->nama->CurrentValue, "", 0);
	}
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`v111_daf_kelas_iuran`";
	}
