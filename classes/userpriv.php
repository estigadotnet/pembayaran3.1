 ...
 * Page class
 */
class userpriv extends t302_userlevels
{
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["t302_userlevels"]))
			$GLOBALS["t302_userlevels"] = &$this;
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 't302_userlevels');
			if ($Security->isLoggedIn())
		...
		$Breadcrumb->add("list", "t302_userlevels", "t302_userlevelslist.php", "", "t302_userlevels");
