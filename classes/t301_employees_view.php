 ...
 * Page class
 */
class t301_employees_view extends t301_employees
{
	...
	// Page object name
	public $PageObjName = "t301_employees_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			$returnUrl = "t301_employeeslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
