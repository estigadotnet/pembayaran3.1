 ...
 * Page class
 */
class t303_userlevelpermissions_add extends t303_userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "t303_userlevelpermissions_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("t303_userlevelpermissionslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "t303_userlevelpermissionslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "t303_userlevelpermissionsview.php")
