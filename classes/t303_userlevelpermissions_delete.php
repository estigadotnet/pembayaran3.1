 ...
 * Page class
 */
class t303_userlevelpermissions_delete extends t303_userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "t303_userlevelpermissions_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t303_userlevelpermissionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t303_userlevelpermissionslist.php"); // Return to list
			}
		}
	}
