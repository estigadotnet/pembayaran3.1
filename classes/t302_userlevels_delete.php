 ...
 * Page class
 */
class t302_userlevels_delete extends t302_userlevels
{
	...
	// Page object name
	public $PageObjName = "t302_userlevels_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t302_userlevelslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t302_userlevelslist.php"); // Return to list
			}
		}
	}
