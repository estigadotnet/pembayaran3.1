...
<input type="hidden" name="x_userlevelid" id="x_userlevelid" value="<?php echo $t302_userlevels->userlevelid->CurrentValue ?>">
<div class="ew-desktop">
<div class="card ew-card ew-grid">
<div class="card-header">
	<h3 class="card-title"><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->getUserLevelName($t302_userlevels->userlevelid->CurrentValue) ?> (<?php echo $t302_userlevels->userlevelid->CurrentValue ?>)</h3>
