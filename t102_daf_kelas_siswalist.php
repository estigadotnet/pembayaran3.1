...
ft102_daf_kelas_siswalist.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		if (checkrow) {
			addcnt++;
		<?php if ($t102_daf_kelas_siswa_list->id->Required) { ?>
...
<?php if ($t102_daf_kelas_siswa->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id" class="<?php echo $t102_daf_kelas_siswa->id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $t102_daf_kelas_siswa->SortUrl($t102_daf_kelas_siswa->id) ?>',2);"><div id="elh_t102_daf_kelas_siswa_id" class="t102_daf_kelas_siswa_id">
...
<span id="el<?php echo $t102_daf_kelas_siswa_list->RowCnt ?>_t102_daf_kelas_siswa_id" class="form-group t102_daf_kelas_siswa_id">
...
<span id="el<?php echo $t102_daf_kelas_siswa_list->RowCnt ?>_t102_daf_kelas_siswa_id" class="t102_daf_kelas_siswa_id">
<span<?php echo $t102_daf_kelas_siswa->id->viewAttributes() ?>>
