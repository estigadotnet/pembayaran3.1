...
var ft003_kelasadd = currentForm = new ew.Form("ft003_kelasadd", "add");
...
ft003_kelasadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t003_kelas_add->Nama->Required) { ?>
...
ft003_kelasadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($t003_kelas_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t003_kelas_add->Token ?>">
<?php } ?>
...
<?php if ($t003_kelas->Nama->Visible) { // Nama ?>
	<div id="r_Nama" class="form-group row">
		<label id="elh_t003_kelas_Nama" for="x_Nama" class="<?php echo $t003_kelas_add->LeftColumnClass ?>"><?php echo $t003_kelas->Nama->caption() ?><?php echo ($t003_kelas->Nama->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t003_kelas_add->RightColumnClass ?>"><div<?php echo $t003_kelas->Nama->cellAttributes() ?>>
