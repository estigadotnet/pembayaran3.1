...
<?php } ?>
<span data-class="tpb<?php echo $Page->GroupCount - 1 ?>_r101_lap_bayar"><?php echo $Page->PageBreakContent ?></span>
<?php } ?>
<?php if ($Page->Export <> "pdf") { ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="keterangan"><div class="r101_lap_bayar_keterangan"><span class="ew-table-header-caption"><?php echo $Page->keterangan->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="keterangan">
<?php if ($Page->sortUrl($Page->keterangan) == "") { ?>
		<div class="ew-table-header-btn r101_lap_bayar_keterangan">
			<span class="ew-table-header-caption"><?php echo $Page->keterangan->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer r101_lap_bayar_keterangan" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->keterangan) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->keterangan->caption() ?></span>
...
<?php if ($Page->IuranNama2->Visible) { ?>
	...
	<?php } else { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="IuranNama2"><div class="r101_lap_bayar_IuranNama2"><span class="ew-table-header-caption"><?php echo $Page->IuranNama2->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="IuranNama2">
<?php if ($Page->sortUrl($Page->IuranNama2) == "") { ?>
		<div class="ew-table-header-btn r101_lap_bayar_IuranNama2">
			<span class="ew-table-header-caption"><?php echo $Page->IuranNama2->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer r101_lap_bayar_IuranNama2" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->IuranNama2) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->IuranNama2->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ew-summary-caption r101_lap_bayar_keterangan"><span class="ew-table-header-caption"><?php echo $Page->keterangan->caption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->sortUrl($Page->keterangan) == "") { ?>
		<span class="ew-summary-caption r101_lap_bayar_keterangan">
			<span class="ew-table-header-caption"><?php echo $Page->keterangan->caption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ew-table-header-btn ew-pointer ew-summary-caption r101_lap_bayar_keterangan" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->keterangan) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->keterangan->caption() ?></span>
			<span class="ew-table-header-sort"><?php if ($Page->keterangan->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($Page->keterangan->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span>
		</span>
	<?php } ?>
...
<span data-class="tpx<?php echo $Page->GroupCount ?>_r101_lap_bayar_keterangan"<?php echo $Page->keterangan->viewAttributes() ?>><?php echo $Page->keterangan->GroupViewValue ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ew-summary-caption r101_lap_bayar_IuranNama2"><span class="ew-table-header-caption"><?php echo $Page->IuranNama2->caption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->sortUrl($Page->IuranNama2) == "") { ?>
		<span class="ew-summary-caption r101_lap_bayar_IuranNama2">
			<span class="ew-table-header-caption"><?php echo $Page->IuranNama2->caption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ew-table-header-btn ew-pointer ew-summary-caption r101_lap_bayar_IuranNama2" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->IuranNama2) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->IuranNama2->caption() ?></span>
			<span class="ew-table-header-sort"><?php if ($Page->IuranNama2->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($Page->IuranNama2->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span>
		</span>
	<?php } ?>
<?php } ?>
		<?php echo $ReportLanguage->phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GroupCount ?>_<?php echo $Page->GroupCounter[0] ?>_r101_lap_bayar_IuranNama2"<?php echo $Page->IuranNama2->viewAttributes() ?>><?php echo $Page->IuranNama2->GroupViewValue ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ew-summary-caption r101_lap_bayar_Jumlah"><span class="ew-table-header-caption"><?php echo $Page->Jumlah->caption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->sortUrl($Page->Jumlah) == "") { ?>
		<span class="ew-summary-caption r101_lap_bayar_Jumlah">
			<span class="ew-table-header-caption"><?php echo $Page->Jumlah->caption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ew-table-header-btn ew-pointer ew-summary-caption r101_lap_bayar_Jumlah" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Jumlah) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->Jumlah->caption() ?></span>
			<span class="ew-table-header-sort"><?php if ($Page->Jumlah->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($Page->Jumlah->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span>
		</span>
	<?php } ?>
<?php } ?>
		<?php echo $ReportLanguage->phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GroupCount ?>_<?php echo $Page->GroupCounter[0] ?>_<?php echo $Page->GroupCounter[1] ?>_r101_lap_bayar_Jumlah"<?php echo $Page->Jumlah->viewAttributes() ?>><?php echo $Page->Jumlah->GroupViewValue ?></span>
...
<span data-class="tpx<?php echo $Page->GroupCount ?>_r101_lap_bayar_keterangan"<?php echo $Page->keterangan->viewAttributes() ?>><?php echo $Page->keterangan->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->IuranNama2->Visible) { ?>
	<?php if ($Page->IuranNama2->ShowGroupHeaderAsRow) { ?>
...
<span data-class="tpx<?php echo $Page->GroupCount ?>_<?php echo $Page->GroupCounter[0] ?>_r101_lap_bayar_IuranNama2"<?php echo $Page->IuranNama2->viewAttributes() ?>><?php echo $Page->IuranNama2->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->Jumlah->Visible) { ?>
	<?php if ($Page->Jumlah->ShowGroupHeaderAsRow) { ?>
...
<span data-class="tpx<?php echo $Page->GroupCount ?>_<?php echo $Page->GroupCounter[0] ?>_<?php echo $Page->GroupCounter[1] ?>_r101_lap_bayar_Jumlah"<?php echo $Page->Jumlah->viewAttributes() ?>><?php echo $Page->Jumlah->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->TahunAjaran->Visible) { ?>
